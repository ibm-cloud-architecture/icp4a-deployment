...
CREATE TABLE db2inst1.PS_WLSTORE (
...
CREATE TABLE db2inst1.LSW_TRACKED_FIELD (
...
ALTER TABLE db2inst1.LSW_TRACKED_FIELD
 ADD CONSTRAINT "EXTERNAL_UNIQUE_ID" CHECK (CHARACTER_LENGTH("EXTERNAL_UNIQUE_ID",CODEUNITS16) <= 64)  ENFORCED ENABLE QUERY OPTIMIZATION
...
CREATE TABLE db2inst1.LSW_TRACKED_FIELD_USE (
...
CREATE TABLE db2inst1.LSW_TIMING_INTERVAL_VALUE (
...
CREATE TABLE db2inst1.LSW_TRACKING_POINT_VALUE (
...
CREATE TABLE db2inst1.LSW_LOAD_TRACE (
...
ALTER TABLE db2inst1.LSW_LOAD_TRACE
...
CREATE TABLE db2inst1.LSW_VIEW (
...
CREATE TABLE db2inst1.LSW_DATA_TRANSFER_ERRORS (
...
ALTER TABLE db2inst1.LSW_DATA_TRANSFER_ERRORS
...
CREATE TABLE db2inst1.LSW_OPTIMIZER_DATA (
"TRACKING_POINT_VALUE_ID" DECIMAL(31, 0) NOT NULL ,
"TRACKED_FIELD_ID" DECIMAL(31, 0) NOT NULL ,
...
ALTER TABLE db2inst1.LSW_USER_MAPPINGS
...
CREATE TABLE db2inst1.LSW_TABLE (
...
ALTER TABLE db2inst1.LSW_TABLE
...
CREATE TABLE db2inst1.LSW_COLUMN (
...
ALTER TABLE db2inst1.LSW_COLUMN
...
ALTER TABLE db2inst1.PS_WLSTORE ADD CONSTRAINT WLC_WLSTORE_PK
    PRIMARY KEY("ID")
...
ALTER TABLE db2inst1.LSW_TRACKING_GROUP ADD CONSTRAINT LSWC_TRCKNGGRP_PK
    PRIMARY KEY("TRACKING_GROUP_ID")

;


ALTER TABLE db2inst1.LSW_TRACKING_POINT ADD CONSTRAINT LSWC_TRCKNGPNT_PK
    PRIMARY KEY("TRACKING_POINT_ID")

;


ALTER TABLE db2inst1.LSW_TRACKED_FIELD ADD CONSTRAINT LSWC_TRCKDFELD_PK
    PRIMARY KEY("TRACKED_FIELD_ID")

;


ALTER TABLE db2inst1.LSW_TRACKED_FIELD_USE ADD CONSTRAINT LSWC_TRCKFLDUS_PK
    PRIMARY KEY("TRACKED_FIELD_USE_ID")

;


ALTER TABLE db2inst1.LSW_TIMING_INTERVAL ADD CONSTRAINT LSWC_TMNGNTRVL_PK
    PRIMARY KEY("TIMING_INTERVAL_ID")

;


ALTER TABLE db2inst1.LSW_TIMING_INTERVAL_BOUND ADD CONSTRAINT LSWC_TMNGNTRVBD_PK
...
ALTER TABLE db2inst1.LSW_TIMING_INTERVAL_VALUE ADD CONSTRAINT LSWC_TMNGNTRVLL_PK
    PRIMARY KEY("TIMING_INTERVAL_VALUE_ID")

;


ALTER TABLE db2inst1.LSW_TRACKING_POINT_VALUE ADD CONSTRAINT LSWC_TRCKNGPNTL_PK
...
ALTER TABLE db2inst1.LSW_LOAD_TRACE ADD CONSTRAINT LSWC_LOADTRACE_PK
    PRIMARY KEY("LOAD_TRACE_ID")

;


ALTER TABLE db2inst1.LSW_VIEW ADD CONSTRAINT LSWC_VIEW_PK
    PRIMARY KEY("VIEW_ID")
...
ALTER TABLE db2inst1.LSW_DATA_TRANSFER_ERRORS ADD CONSTRAINT LSWC_DT_ERR_PK
    PRIMARY KEY("DATA_TRANSFER_ERRORS_ID")

;


ALTER TABLE db2inst1.LSW_OPTIMIZER_DATA ADD CONSTRAINT LSWC_OPTDATA_PK
    PRIMARY KEY("TRACKING_POINT_VALUE_ID","TRACKED_FIELD_ID")

;


ALTER TABLE db2inst1.LSW_USER_MAPPINGS ADD CONSTRAINT LSWC_USERMAP_PK
...
ALTER TABLE db2inst1.LSW_TABLE ADD CONSTRAINT LSWC_TABLE_PK
    PRIMARY KEY("TABLE_ID")

;


ALTER TABLE db2inst1.LSW_COLUMN ADD CONSTRAINT LSWC_COLUMN_PK
...
CREATE UNIQUE INDEX db2inst1.LSWC_SYSTEM_UQ0
    ON db2inst1.LSW_SYSTEM(
        "NAME")
    
;


CREATE INDEX db2inst1.LSWC_TRCKNGGRP_PK4
...
ALTER TABLE db2inst1.LSW_TRACKING_GROUP
	...
	REFERENCES db2inst1.LSW_SYSTEM("SYSTEM_ID")
	
;


CREATE UNIQUE INDEX db2inst1.LSWC_TRCKNGGRP_UQ1
...
CREATE INDEX db2inst1.LSWC_TRCKNGGRP_NQ1 
    ON db2inst1.LSW_TRACKING_GROUP(
    "SYSTEM_ID")
...
CREATE INDEX db2inst1.LSWC_TRCKNGPNT_PK4
    ON db2inst1.LSW_TRACKING_POINT("NAME")
...
ALTER TABLE db2inst1.LSW_TRACKING_POINT
	...
	REFERENCES db2inst1.LSW_TRACKING_GROUP("TRACKING_GROUP_ID")
	
;


CREATE UNIQUE INDEX db2inst1.LSWC_TRCKNGPNT_UQ1
    ON db2inst1.LSW_TRACKING_POINT(
        "SYSTEM_ID",
        "EXTERNAL_UNIQUE_ID",
        "SNAPSHOT_ID")
...
CREATE INDEX db2inst1.LSWC_TRCKNGPNT_NQ0 
    ON db2inst1.LSW_TRACKING_POINT(
    "TRACKING_GROUP_ID")
...
CREATE INDEX db2inst1.LSWC_TRCKDFELD_PK4
    ON db2inst1.LSW_TRACKED_FIELD("NAME")
...
CREATE UNIQUE INDEX db2inst1.LSWC_TRCKDFELD_UQ0
    ON db2inst1.LSW_TRACKED_FIELD(
        "TRACKING_GROUP_ID",
        "EXTERNAL_UNIQUE_ID",
        "SNAPSHOT_ID")
...
CREATE INDEX db2inst1.LSWC_TRCKDFELD_NQ0 
    ON db2inst1.LSW_TRACKED_FIELD(
    "TRACKING_GROUP_ID")
...
ALTER TABLE db2inst1.LSW_TRACKED_FIELD_USE
    ADD CONSTRAINT LSWC_TRCKFLDUS_FK0
	FOREIGN KEY("TRACKED_FIELD_ID")
	REFERENCES db2inst1.LSW_TRACKED_FIELD("TRACKED_FIELD_ID")
...
ALTER TABLE db2inst1.LSW_TRACKED_FIELD_USE
	...
	REFERENCES db2inst1.LSW_TRACKING_POINT("TRACKING_POINT_ID")
	
;


CREATE INDEX db2inst1.LSWC_TRCKFLDUS_NQ0 
    ON db2inst1.LSW_TRACKED_FIELD_USE(
    "TRACKED_FIELD_ID")
    
;


CREATE INDEX db2inst1.LSWC_TRCKFLDUS_NQ1 
    ON db2inst1.LSW_TRACKED_FIELD_USE(
    "TRACKING_POINT_ID")
...
CREATE INDEX db2inst1.LSWC_TMNGNTRVL_PK4
...
CREATE UNIQUE INDEX db2inst1.LSWC_TMNGNTRVL_UQ1
    ON db2inst1.LSW_TIMING_INTERVAL(
        "SYSTEM_ID",
        "EXTERNAL_UNIQUE_ID")
...
CREATE INDEX db2inst1.LSWC_TMNGNTRVL_NQ1 
    ON db2inst1.LSW_TIMING_INTERVAL(
    "SYSTEM_ID")
...
ALTER TABLE db2inst1.LSW_TIMING_INTERVAL_BOUND
	...
	REFERENCES db2inst1.LSW_TIMING_INTERVAL("TIMING_INTERVAL_ID")
...
CREATE INDEX db2inst1.LSWC_TMNGNTVBD_NQ0 
    ON db2inst1.LSW_TIMING_INTERVAL_BOUND(
    "TIMING_INTERVAL_ID")
    
;


CREATE INDEX db2inst1.LSWC_TMNGNTVBD_NQ1 
    ON db2inst1.LSW_TIMING_INTERVAL_BOUND(
    "TRACKING_POINT_ID")
...
CREATE UNIQUE INDEX db2inst1.LSWC_TASK_UQ0
...
CREATE INDEX db2inst1.LSWC_TASK_NQ0 
    ON db2inst1.LSW_TASK(
    "SYSTEM_ID")
...
CREATE INDEX db2inst1.LSWC_TASK_NQ1 
    ON db2inst1.LSW_TASK(
    "IS_INSTANCE")
...
CREATE INDEX db2inst1.LSWC_TASK_NQ2 
    ON db2inst1.LSW_TASK(
    "FUNCTIONAL_TASK_ID")
...
CREATE INDEX db2inst1.LSWC_TASK_NQ3 
    ON db2inst1.LSW_TASK(
    "MAX_STEP")
...
CREATE INDEX db2inst1.LSWC_TASK_NQ4 
    ON db2inst1.LSW_TASK(
    "CREATION_TIME",
    "TASK_ID")
...
CREATE INDEX db2inst1.LSWC_TASK_NQ5 
    ON db2inst1.LSW_TASK(
    "START_TIME",
    "TASK_ID")
...
CREATE INDEX db2inst1.LSWC_TASK_NQ6 
    ON db2inst1.LSW_TASK(
    "END_TIME",
    "TASK_ID")
...
ALTER TABLE db2inst1.LSW_TIMING_INTERVAL_VALUE
...
CREATE INDEX db2inst1.LSWC_TMNGNTRLL_NQ0 
    ON db2inst1.LSW_TIMING_INTERVAL_VALUE(
    "TIMING_INTERVAL_ID")
    
;


CREATE INDEX db2inst1.LSWC_TMNGNTRLL_NQ1 
    ON db2inst1.LSW_TIMING_INTERVAL_VALUE(
    "FUNCTIONAL_TASK_ID")
...
CREATE INDEX db2inst1.LSWC_TMNGNTRLL_UQ0 
    ON db2inst1.LSW_TIMING_INTERVAL_VALUE(
    "TIMING_INTERVAL_ID",
...
ALTER TABLE db2inst1.LSW_TRACKING_POINT_VALUE
...
CREATE INDEX db2inst1.LSWC_TRCKNGPTL_NQ0 
    ON db2inst1.LSW_TRACKING_POINT_VALUE(
    "TRACKING_POINT_ID")
    
;


CREATE INDEX db2inst1.LSWC_TRCKNGPTL_NQ1 
    ON db2inst1.LSW_TRACKING_POINT_VALUE(
    "TASK_ID")
...
CREATE INDEX db2inst1.LSWC_TRCKNGPTL_NQ2 
    ON db2inst1.LSW_TRACKING_POINT_VALUE(
    "FUNCTIONAL_TASK_ID")
...
CREATE INDEX db2inst1.LSWC_TRCKNGPTL_NQ3 
    ON db2inst1.LSW_TRACKING_POINT_VALUE(
    "TRACKING_GROUP_ID",
    "TRACKING_POINT_ID",
...
CREATE INDEX db2inst1.LSWC_TRCKNGPTL_NQ4 
    ON db2inst1.LSW_TRACKING_POINT_VALUE(
    "TIME_STAMP",
    "TRACKING_POINT_VALUE_ID")
...
CREATE INDEX db2inst1.LSWC_LDTRACE_NUQ 
    ON db2inst1.LSW_LOAD_TRACE(
    "SYNCHRONIZATION_EUID")
    
;


CREATE INDEX db2inst1.LSWC_LDTRACE_NUQ1 
    ON db2inst1.LSW_LOAD_TRACE(
    "LOAD_TRACE_ID",
    "SYNCHRONIZATION_EUID",
    "LOAD_TYPE",
...
ALTER TABLE db2inst1.LSW_VIEW
	...
	REFERENCES db2inst1.LSW_TABLE("TABLE_ID")
	
;


CREATE UNIQUE INDEX db2inst1.LSWC_VIEW_NAME_UQ
    ON db2inst1.LSW_VIEW(
        "NAME")
...
CREATE INDEX db2inst1.LSWC_DT_ERR_NUQ 
    ON db2inst1.LSW_DATA_TRANSFER_ERRORS(
    "CLAIMED_BY",
    "REPROCESS")
...
CREATE INDEX db2inst1.LSWC_SNAPSHOT_PK4
    ON db2inst1.LSW_SNAPSHOT("NAME")
